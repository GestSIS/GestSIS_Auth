...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $elements = array(
            ...
            array('id' => 3, 'tri' => 400, 'nom' => 'Comptabilité', 'description' => 'Comptabilité, contrôle total', 'api_key' => 'comptabilite.tout'),
            ...
            array('id' => 7, 'tri' => 310, 'nom' => 'Exercice saisie des présences', 'description' => 'Saisie des présences pour exercice', 'api_key' => 'exercice.presence'),
            array('id' => 8, 'tri' => 320, 'nom' => 'Exercice validation', 'description' => 'Validation des exercices', 'api_key' => 'exercice.validation'),
            ...
            // Rajouté
            array('id' => 21, 'tri' => 300, 'nom' => 'Exercice lecture', 'description' => 'Affichage des exercices', 'api_key' => 'exercice.lecture'),
